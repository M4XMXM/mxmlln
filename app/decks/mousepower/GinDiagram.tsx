...
//   step 0 — schematic animating with its labels; equation hidden.
...
// so they run only while this slide is active.
      ...
      <svg className="hp-diagram" viewBox="0 0 300 216" fill="none" aria-hidden>
        ...
        <g className="hp-spin">
          ...
          <line
            ...
            strokeLinecap="round"
          />
          {/* Bridges the beam gap once the "12 ft" label clears (step 1), so the
              rotary arm reads as one continuous line. */}
          <line
